if (document.body.classList.contains("page-topics")) {
  /**
  ...
  document.querySelectorAll(".playlist-move-up").forEach(function (btn) {
  ...
  document.querySelectorAll(".playlist-move-down").forEach(function (btn) {
    btn.closest("form").addEventListener("ajax:success", () => {
      const row = btn.closest("tr");
