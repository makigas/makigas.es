  ...
  let(:shape) do
    {
      ...
      '@graph' => an_object_matching(
        [
          ...
          a_hash_including('@id' => "https://www.makigas.es/series/#{playlist.slug}#course"),
          a_hash_including('@id' => "https://www.makigas.es/series/#{playlist.slug}/#{playlist.videos.first.slug}#lesson")
        ]
      )
    }
  end
