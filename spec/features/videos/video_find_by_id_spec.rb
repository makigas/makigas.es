...
RSpec.describe 'Video find by ID', type: :feature do
  let(:playlist) { FactoryBot.create(:playlist, title: 'Videos musicales') }
  let(:video) { FactoryBot.create(:video, title: 'Open Door', playlist: playlist, youtube_id: '6VBwEeUkFrQ') }
